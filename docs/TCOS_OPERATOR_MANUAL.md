...
Open `/admin/shipping/simulations` or run `npm run simulate:shipping`. Require all seventeen policy/adapter assertions:
...
- Mark Paid buyer-refund gate requires an internal note confirming buyer/customer refund evidence or a refund reference before TCOS seller-protection reimbursement
