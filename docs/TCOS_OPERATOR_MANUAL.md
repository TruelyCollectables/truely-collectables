...
- seller account, command-center, payout, and order workspaces expose the withheld reserve, protected/liability row counts, protected item amount, and shipping-excluded amount so sellers can see how the optional internal protection affected cash-out math
