...
- seller account, command-center, payout, order, and admin payout workspaces expose the withheld reserve, protected/liability row counts, protected item amount, and shipping-excluded amount so sellers and operators can see how the optional internal protection affected cash-out math
