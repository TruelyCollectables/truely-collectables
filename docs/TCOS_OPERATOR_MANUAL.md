...
- Seller Inventory bulk action result cards now include `Copy Bulk Report` for a JSON audit/debug handoff with success, failure, blocker, and retry-ready details.
