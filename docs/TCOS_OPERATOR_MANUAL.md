...
- Printed variant/parallel identity is guarded so visible Limited Red, Clear Cut, Outliers, Future Watch, Spectrum FX, acetate/clear-stock, insert, color foil, refractor, prizm, holo, wave, shimmer, ice, laser, scope, pulsar, mojo, mosaic, and similar cues cannot stay as generic base. Ambiguous printed cues stay in review rather than being overclaimed.
