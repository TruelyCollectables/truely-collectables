...
- `/admin/production-smoke` now includes a post-smoke manual verification checklist with proof targets and blocked-action instructions for Git/domain freshness, Launch Gate Drill evidence, live-shipping lock posture, seller-protection money trail, shipping operations exports, Seller Connections Marketplace Packet Intake guardrails, and Seller Connections receipt handoff controls
