...
This runs lint, the InstaComp queue and accuracy simulations, the LetterTrack evidence checks, the fourteen-scenario shipping simulation suite, build, and the production preflight without starting a Vercel deployment.
...
This runs lint, InstaComp regression simulations, LetterTrack evidence checks, the fourteen-scenario shipping simulation suite, build, production guardrail checks, production preflight, production deploy, and production smoke in order.
