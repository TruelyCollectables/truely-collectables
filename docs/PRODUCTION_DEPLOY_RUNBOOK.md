...
This runs lint, the InstaComp queue, accuracy, and catalog identity simulations, the LetterTrack evidence checks, shipping purchase-attempt audit simulations, the twenty-scenario shipping simulation suite, build, and the production preflight without starting a Vercel deployment.
