...
That command is deploy-safe: it runs lint, InstaComp regressions, LetterTrack evidence checks, the sixteen-scenario shipping simulation suite, build, production guardrail checks, and production Git preflight without consuming a Vercel deployment.
