  ...
  const adminToolGroups = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/admin/instacomp/pricing", label: "InstaComp Pricing" },
        ...
        { href: "/admin/instacomp/pricing/coverage/work-orders", label: "Pricing Work Orders" },
        { href: "/admin/instacomp/pricing/profiles", label: "Pricing Profiles" },
        { href: "/admin/instacomp/pricing/bulk-plan", label: "Pricing Bulk Plan" },
        { href: "/admin/instacomp/pricing/scenarios", label: "Pricing Scenarios" },
        { href: "/admin/instacomp/pricing/review", label: "Pricing Review" },
        { href: "/admin/instacomp/pricing/views", label: "Pricing Saved Views" },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/admin/market-intel/deal-hunter/price-insights", label: "Deal Hunter Price Insights" },
        { href: "/admin/market-intel/kingmaker", label: "Capital Intelligence Command" },
        { href: "/admin/market-intel/kingmaker/capital-ledger", label: "Purchase Ledger Command" },
        { href: "/admin/market-intel/kingmaker/morning-intelligence", label: "Controlled Delivery Console" },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/admin/shipping/shipstation-test", label: "ShipStation Test" },
        { href: "/admin/shipping/test-shipment", label: "Test Shipment" },
    ...
    },
    {
      ...
      links: [
        { href: "/admin/promotions", label: "Coupons" },
