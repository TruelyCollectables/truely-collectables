  ...
  return (
    <>
      ...
      >
        ...
        <span className="relative block text-[10px] font-black uppercase tracking-[.24em] text-amber-300">
          Project KINGMAKER Beta 1.0
        </span>
        <span className="relative mt-1 block text-lg font-black tracking-tight">
