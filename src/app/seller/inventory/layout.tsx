        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-black tracking-tight sm:text-3xl">
              InstaComp Verified Cards
            </h2>
            <p className="mt-2 max-w-4xl text-sm font-semibold leading-6 text-slate-200">
              Human-approved front/back scan pairs arrive here as private drafts.
              The exact card serial, grading company, grade, certification number,
              official cert evidence, and physical-card history stay attached through
              listing, sale, and post-sale market tracking.
            </p>
          </div>
