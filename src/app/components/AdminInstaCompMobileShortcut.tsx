      ...
      <div className="grid grid-cols-5 gap-1 sm:flex sm:items-center sm:gap-2">
        {adminMobileLinks.map((item) => (
          <Link
            key={item.href}
            href={item.href}
            className="flex min-h-14 flex-col items-center justify-center rounded-xl px-1.5 py-2 text-center text-[9px] font-black leading-tight transition hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300 sm:min-h-12 sm:flex-row sm:gap-2 sm:px-3 sm:text-xs"
          >
