...
function deploySafetyMarkdownLines() {
  return [
    ...
    "",
    "- Run `npm run verify:production` before launch work; it covers InstaComp regressions, LetterTrack evidence checks, the fourteen-scenario shipping simulation suite, build, production guardrails, and production preflight.",
...
function markdownForHandoffBundle(
  ...
  return [
    ...
    "",
    "- Before deploying, run `npm run verify:production`; it covers InstaComp regressions, LetterTrack evidence checks, the fourteen-scenario shipping simulation suite, build, production guardrails, and production preflight.",
    ...
    "- Confirm production smoke POSTs `/api/admin/shipping/simulations` and verifies fourteen expected scenarios, passed scenario key coverage, and no missing or unexpected scenario keys.",
