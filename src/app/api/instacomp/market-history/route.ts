...
import { loadExactCardMarketHistory, persistExactCardMarketHistory, type InstaCompRegistryTruth } from "../../../../lib/instacomp-market-history";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const target = body.targetListing && typeof body.targetListing === "object" ? targetAsComp(body.targetListing as TargetListing) : null;
