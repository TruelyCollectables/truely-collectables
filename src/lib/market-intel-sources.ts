...
const sourceRegistry = [
  ...
  },
  {
    ...
    statusLabel: "MANUAL DEAL DISCOVERY",
    ...
    directLinkSupport: true,
    authorizationStatus:
      "Operators may manually open SportsCardsPro pages and follow marketplace links to discover possible deals. Price Data, sold-history summaries, guide values, trends, and automated integration remain disabled until TCOS obtains the required subscription, license, or written permission.",
    rateLimitNotes:
      "No automated SportsCardsPro requests, monitoring, scraping, or Price Data storage. Operators may manually open pages and independently verify marketplace listings.",
    warnings: [
      "Use SportsCardsPro only to locate candidate marketplace listings and buying opportunities.",
      "Do not copy guide prices, historic-sale tables, sales volume, trends, or calculated values into TCOS without the required license or written permission.",
      "Independently verify the exact card, seller, asking price, shipping, condition, and direct marketplace URL before creating a Profit Hunter candidate.",
      "When the budget allows, evaluate the appropriate SportsCardsPro subscription and written software-use permission before enabling price-data integration.",
    ],
    lastSuccessfulScan: null,
    lastError: null,
  },
