...
function buildSetBuilderLinks(product: UniversalInventoryItem): CollectorSourceLink[] {
  ...
  const links: CollectorSourceLink[] = [
    {
      ...
      description:
        "Search Truely Collectables first for this exact title or nearby inventory matches.",
    },
    {
...
export function buildCollectorIntelligence(
  ...
  const marketLinks: CollectorSourceLink[] = [
    {
      ...
      description: "Look for this or related items inside Truely Collectables first.",
    },
    {
  ...
  return {
    ...
    marketLinks,
    acquisitionLinks,
    setBuilderLinks: buildSetBuilderLinks(product),
    newsLinks,
