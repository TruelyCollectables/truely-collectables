...
scenario("bulk description editor exposes searchable safe bulk controls", () => {
  for (const fragment of [
    ...
    "No visible products match the current bulk editor search.",
    "Selected every product currently visible in this bulk editor list.",
    "Cleared the products currently visible in this bulk editor list.",
    "selectionMessage",
