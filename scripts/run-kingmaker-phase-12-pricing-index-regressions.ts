...
const points: KingmakerPricePoint[] = [
  { identityKey: "card:a", guideId: "guide-aug", editionDate: "2026-08-01", valueLow: 80, valueHigh: 120, currency: "usd", confidence: 0.99, validationStatus: "accepted", identityMatchStatus: "exact", sourceEngine: "text" },
  { identityKey: "card:a", guideId: "guide-sep", editionDate: "2026-09-01", valueLow: 100, valueHigh: 140, currency: "usd", confidence: 0.94, validationStatus: "review", identityMatchStatus: "exact", sourceEngine: "ocr" },
  { identityKey: "card:b", guideId: "guide-sep", editionDate: "2026-09-01", valueLow: 20, valueHigh: 30, currency: "USD", confidence: 0.99, validationStatus: "accepted", identityMatchStatus: "exact", sourceEngine: "text" },
  { identityKey: "card:ignored", guideId: "guide-sep", editionDate: "2026-09-01", valueLow: 500, valueHigh: 600, currency: "USD", confidence: 1, validationStatus: "review", identityMatchStatus: "ambiguous", sourceEngine: "ocr" },
];
...
assert.equal(index.fingerprint, buildKingmakerPricingIndex([...points].reverse()).fingerprint);
