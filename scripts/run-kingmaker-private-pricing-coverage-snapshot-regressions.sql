...
begin
  ...
  insert into public.checklist_source_files (
    ...
    set_gap_release_id,
    'checklist',
    'https://example.invalid/set-gap',
    'set-gap.csv',
    'snapshot-regression/set-gap.csv',
    'text/csv',
    1,
    repeat('c', 64),
    'snapshot-regression-v1',
    'successful',
    'passed'
  ...
  insert into public.checklist_source_files (
    ...
    'checklist',
    'https://example.invalid/identity-gap',
    'identity-gap.csv',
    'snapshot-regression/identity-gap.csv',
    'text/csv',
    1,
    repeat('d', 64),
    'snapshot-regression-v1',
  ...
  select
    ...
    'Base',
    concat('I', series),
    concat('Identity Gap Player ', series),
    1,
    2,
    'private row',
    0.94,
    'review',
    case when series = 2 then 'ambiguous' else 'unmatched' end
