...
const smokeRoutes = [
  ...
  { path: "/admin/market-intel/kingmaker", auth: true, expectedText: "Capital Intelligence Command" },
  ...
  { path: "/admin/instacomp/seller-sweep", auth: true, expectedText: "InstaComp™ Seller Sweep" },
