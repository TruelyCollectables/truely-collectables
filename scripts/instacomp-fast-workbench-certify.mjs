...
const checks = [
  ...
  ['scan route preserves season year', scanRoute.includes('preserveSeasonYear') && scanRoute.includes('preserveSeasonYear(listingIdentityHint.year || consensusAi.year, registryMatch.year)')],
  ...
  ['operator override drives exact identity', scanRoute.includes('applyOperatorIdentityOverride(registryAi, operatorIdentityOverride)')],
