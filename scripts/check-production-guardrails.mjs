...
assertScriptIncludes("simulate:instacomp-trial-prep", [
  "scripts/prepare-instacomp-trial.mjs",
  "--worksheet .codex-run/instacomp-trial-groundtruth-prep-fixture.local.tsv",
...
assertScriptIncludes("simulate:instacomp-trial-stage", [
  "scripts/stage-instacomp-trial-images.mjs",
  "--source scripts/fixtures/instacomp-trial-images.example",
  "--target .codex-run/instacomp-trial-stage-images-fixture",
  "--receipt-json .codex-run/instacomp-trial-stage-fixture.local.json",
  "--receipt-md .codex-run/instacomp-trial-stage-fixture.local.md",
  "--expected-cards 3",
  "--apply",
  "--overwrite",
]);
...
assertScriptIncludes("simulate:instacomp-trial-answer-key-html", [
  "scripts/write-instacomp-trial-answer-key-html.mjs",
...
assertScriptIncludes("simulate:instacomp-trial-intake", [
  ...
  "--source scripts/fixtures/instacomp-trial-images.example",
  "--target .codex-run/instacomp-trial-intake-images-fixture",
  "--intake-json .codex-run/instacomp-trial-intake-fixture.local.json",
  "--intake-md .codex-run/instacomp-trial-intake-fixture.local.md",
  "--answer-key-guide .codex-run/instacomp-trial-groundtruth-guide-fixture.local.md",
  "--sync-write-manifest .codex-run/instacomp-trial-intake-manifest-fixture.local.json",
  "--no-ensure-folders",
  "--expected-cards 3",
]);
...
assertScriptIncludes("instacomp:trial:answer-key-html", [
  "scripts/write-instacomp-trial-answer-key-html.mjs",
...
assertScriptIncludes("instacomp:trial:prep", [
  "scripts/prepare-instacomp-trial.mjs",
  "--worksheet instacomp-trial-groundtruth.local.tsv",
...
assertScriptIncludes("instacomp:trial:stage-images", [
  "scripts/stage-instacomp-trial-images.mjs",
  "--source instacomp-trial-inbox",
  "--target instacomp-trial-images",
...
assertScriptIncludes("instacomp:trial:intake", [
  "scripts/run-instacomp-trial-intake.mjs",
  "--source instacomp-trial-inbox",
  "--target instacomp-trial-images",
  "--intake-json instacomp-trial-intake.local.json",
  "--intake-md instacomp-trial-intake.local.md",
  "--answer-key-guide instacomp-trial-groundtruth-guide.local.md",
  "--expected-cards 100",
]);
...
assertFileIncludes("instacomp trial answer-key HTML generator", "scripts/write-instacomp-trial-answer-key-html.mjs", [
  "tcos.instacompTrialAnswerKeyHtml.v1",
  "TCOS InstaComp™ Trial Answer-Key Review",
  "front/back thumbnails",
  "Copy updated TSV",
  "Download updated TSV",
  "Search rows",
  "Missing required",
  "Image issues",
  "updateVisibleRows",
...
assertFileIncludes("instacomp multi-scanner consensus source", "src/lib/instacomp-consensus.ts", [
  ...
  "full_council_missing_second_ai_reader",
  ...
  "hasInsertStyleCardNumberPrefix",
  "hasAutographOrRelicSignal",
...
assertFileIncludes("instacomp curated checklist source", "src/lib/instacomp-curated-checklist.ts", [
  "TCOS Curated Checklist",
  "tcos_curated_checklist",
  "buildInstaCompCuratedChecklistEvidence",
  "catalogEvidenceToConsensusReferee",
  "tcos-2025-26-sp-authentic-hockey-o-8-outliers",
  "tcos-2025-26-upper-deck-extended-series-c-369-canvas-young-guns",
  "tcos-2025-26-upper-deck-extended-series-ud3-28-clear-cut",
  "tcos-2022-23-upper-deck-extended-series-656-clear-cut",
  "tcos-2025-26-sp-authentic-hockey-s-50-spectrum-fx-level-1",
...
assertFileIncludes("instacomp trial results export UI wiring", "src/app/admin/instacomp/InstaCompScanner.tsx", [
  ...
  "Copy Trial Results",
  "instacompTrialCatalogEvidenceSummary",
  "catalogEvidence",
  "catalogConfirmed",
...
assertFileIncludes("instacomp multi-scanner consensus simulations", "scripts/run-instacomp-consensus-simulations.ts", [
  ...
  "insert card-number prefix cannot fast-lane as generic base",
...
assertFileIncludes("instacomp trial preflight source", "scripts/run-instacomp-trial-preflight.mjs", [
  ...
  "readyForCurrentAudit",
  "missingImageFiles",
  "missingPairs",
  "Copy the missing ${finalImageStatus.missingImageFiles} image file(s) / ${finalImageStatus.missingPairs} card pair(s)",
...
assertFileIncludes("instacomp trial prep bundle source", "scripts/prepare-instacomp-trial.mjs", [
  "tcos.instacompTrialPrepBundle.v1",
  "Existing answer-key worksheet preserved",
  "Scan permit:",
  "Ordered operator next actions",
  "npm run instacomp:trial:answer-key:validate",
  "--force-worksheet",
  "instacomp-trial-preflight.local.json",
...
assertFileIncludes("instacomp trial image staging source", "scripts/stage-instacomp-trial-images.mjs", [
  "tcos.instacompTrialImageStage.v1",
  "instacomp-trial-inbox",
  "instacomp-trial-images",
  "instacomp-trial-stage.local.json",
  "instacomp-trial-stage.local.md",
  "--apply",
  "--overwrite",
  "Dry run is clean",
...
assertFileIncludes("instacomp trial intake cockpit source", "scripts/run-instacomp-trial-intake.mjs", [
  ...
  "README_TCOS_INSTACOMP_TRIAL.txt",
  "buildSourceGuide",
  "buildTargetGuide",
  "buildGroundTruthGuide",
...
assertFileIncludes("instacomp local trial ignore rules", ".gitignore", [
  "/instacomp-trial-inbox/",
  "/instacomp-trial-images/",
  "/instacomp-trial-*.local.json",
  "/instacomp-trial-*.local.md",
  "/instacomp-trial-*.local.tsv",
  "/instacomp-trial-*.local.html",
]);
assertFileIncludes("instacomp trial readiness monitor source", "scripts/watch-instacomp-trial-readiness.mjs", [
  ...
  "answerKeyValidation",
  "shortLot",
  "final-trial front/back pairs are complete",
  "Copy the missing ${missingImageFiles} image file(s) / ${missingPairs} card pair(s)",
  "readinessGates",
  "receiptStatus",
  "receiptsExist",
  "current for loaded images, but final lot is still",
  "final image lot is complete",
  "operatorNextActions",
  "buildReadinessGates",
  "buildOperatorNextActions",
  "readiness gates:",
...
assertFileIncludes("instacomp trial ground-truth manifest audit manual", "docs/TCOS_OPERATOR_MANUAL.md", [
  ...
  "writes `README_TCOS_INSTACOMP_TRIAL.txt` guide files inside both ignored folders",
  "instacomp-trial-intake.local.json",
  "instacomp-trial-groundtruth-guide.local.md",
  "required answer-key fields",
  "`player`, `year`, `setName`, and `cardNumber`",
  "one next action",
  "npm run instacomp:trial:stage-images",
  "tcos.instacompTrialImageStage.v1",
  "instacomp-trial-inbox/",
...
assertFileIncludes("instacomp final tester status includes trial image audit", "scripts/status-instacomp-final-tester.mjs", [
  ...
  "Visual answer-key sheet matches the loaded ${loadedCards}/${expectedCards} card worksheet",
  "trial_answer_key_validation",
  "trial_prep_bundle",
  "trial_intake_cockpit",
  "trial_image_staging",
  "trial_raw_inbox_dropzone",
  "trial_image_path_sync",
  "trial_readiness_monitor",
  "ordered operator next actions",
  "explicit scan permit",
  "runTrialPreflightStatus",
  "trial scan permit:",
  "trial scan warning:",
  "trial preflight next actions:",
  "SCAN_PERMIT_UNKNOWN",
  "trial_image_audit",
  "trial_image_map",
  ...
  "getFinalTrialImageShortfall",
  "describeFinalTrialImageShortfall",
  "getTrialReceiptStatus",
  "getTrialReceiptNext",
  "getFinalTesterNext",
  "Do not scan yet. Clear the final tester preflight blockers first.",
  "Scan the prepared 100-card lot at /admin/instacomp",
  "Repair the final tester preflight status first",
  "trialImageMapNext",
  "trialIntakePacketNext",
  "imageMap: { ...trialImageMap, next: trialImageMapNext }",
  "intakePacket: { ...trialIntakePacket, next: trialIntakePacketNext }",
  "receipt_current_but_final_lot_short",
  "receipt_current_but_scan_permit_blocked",
  "receipt_current_but_preflight_unknown",
  "scan_permit_blocked",
  ...
  "countNonImageFilesIfPresent",
  "trialInboxDir",
  "trialInboxAbsolutePath",
  "inboxImageFileCount",
  "inboxNonImageFileCount",
  "ready_for_intake",
  "partial_raw_inbox",
  "nonImageFileCount",
  "tcos.instacompTrialImageMap.v1",
  ...
  "trial answer-key worksheet:",
  "trial answer-key worksheet columns:",
  "trial answer-key worksheet next:",
  "validate it",
  "worksheet_current_but_needs_groundtruth",
  "needs_groundtruth_sheet",
  "ready_to_apply",
  "instacomp-trial-groundtruth.local.tsv",
  "trial answer-key guide:",
  "trial answer-key guide next:",
  "instacomp-trial-groundtruth-guide.local.md",
  "guide_current_but_needs_groundtruth",
  "needs_answer_key_guide",
  "trial answer-key HTML:",
  "trial answer-key HTML next:",
