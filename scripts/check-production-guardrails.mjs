...
assertFileIncludes("go-live runway status helper source", "scripts/status-go-live.mjs", [
  ...
  "Run npm run prepare:live-money-bootstrap",
...
assertFileIncludes("live money go/no-go README instructions", "README.md", [
  ...
  "one-command safe handoff `npm run prepare:live-money-bootstrap`",
  "The expanded command chain remains available as `npm run live-money:env-packet`",
  ...
  "Vercel quota status",
  "go-live-readiness",
  "Live-money blockers point to the one-command safe handoff",
  ...
  "npm --silent run verify:live-money-env-packet:json",
  "tcos.liveMoneyEnvPacketVerification.v1",
  "checksum and no-secret verification",
  "npm run archive:live-money-env-packet-verification",
