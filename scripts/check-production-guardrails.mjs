...
assertFileIncludes("launch readiness smoke contract", "scripts/smoke-production.mjs", [
  ...
  '"controls":["Copy Safe Receipt","Download Safe Receipt","Copy Trail","Download Trail","Clear Trail"]',
  '"safeUseBoundary":"Treat the receipt trail as a safe operator handoff aid, not an audit ledger, payment record, fulfillment proof, or provider reconciliation source of truth."',
  ...
  "## Seller Marketplace Receipt Handoff",
  "Proof text: Seller marketplace receipt handoff proof text",
  "Controls: Copy Safe Receipt, Download Safe Receipt, Copy Trail, Download Trail, Clear Trail",
  "Safe-use boundary: Treat the receipt trail as a safe operator handoff aid, not an audit ledger, payment record, fulfillment proof, or provider reconciliation source of truth.",
...
assertFileIncludes("deploy live safety production smoke page", "src/app/admin/production-smoke/page.tsx", [
  ...
  "Shipping operations exports",
  "Seller marketplace receipt handoff",
  "Copy Safe Receipt, Download Safe Receipt, Copy Trail, Download Trail, and Clear Trail",
