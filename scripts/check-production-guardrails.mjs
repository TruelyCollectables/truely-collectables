...
assertFileIncludes("live money go/no-go README instructions", "README.md", [
  ...
  "verify the checksum sidecar with `npm run verify:live-money-env-packet`",
  "archive that verification with `npm run archive:live-money-env-packet-verification`",
