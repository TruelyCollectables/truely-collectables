-- Extend the source-neutral private work-order activity report to cover the
-- administrator execution controls introduced after the original timeline.
-- Attack keys, assignee text, private notes, source material, and pricing values
-- remain sealed inside the database.
