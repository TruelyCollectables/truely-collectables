...
create index if not exists tcos_kingmaker_price_index_entity_idx
  on public.tcos_kingmaker_price_index (entity_key, edition_date desc);
create index if not exists tcos_kingmaker_price_index_status_idx
  on public.tcos_kingmaker_price_index (status, refreshed_at desc);
create index if not exists tcos_kingmaker_price_history_identity_date_idx
  on public.tcos_kingmaker_price_history (checklist_identity_id, edition_date desc);
