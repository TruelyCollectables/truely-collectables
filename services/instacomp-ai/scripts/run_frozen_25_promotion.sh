...
target="$service_root/scripts/promote_lora_candidate_frozen_25_v5.py"
...
echo "PASS Frozen 25 launcher mode: promotion-v5-image-witness-live-registry-preflight"
