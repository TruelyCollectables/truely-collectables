...
target="$service_root/scripts/promote_lora_candidate_frozen_25_v6.py"
...
echo "PASS Frozen 25 launcher mode: promotion-v6-fresh-runtime-reload-image-witness-live-registry-preflight"
