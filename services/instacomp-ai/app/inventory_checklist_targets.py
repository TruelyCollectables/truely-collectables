...
def build_inventory_checklist_targets(registry_path: Path) -> dict[str, Any]:
    ...
    # Do not force the broad player index here. On the multi-million-row Registry,
    # SQLite's planner correctly chooses the more selective card/year/player
    # resolve index for exact lookups; forcing player_idx made 7k+ startup
    # inventory checks take minutes.
    player_hint = ""
