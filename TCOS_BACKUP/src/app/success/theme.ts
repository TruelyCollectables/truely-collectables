...
function defaultTheme(defaultName: string): SuccessTheme {
  return {
    name: defaultName,
    primary: "#171717",
    secondary: "#facc15",
...
export function inferSuccessTheme(
  ...
  return matchingRule?.theme || defaultTheme(options.defaultName?.trim() || "Storefront");
}
